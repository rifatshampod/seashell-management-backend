...
Revision ID: 4216b852d562
Revises: 
Create Date: 2026-02-08 00:18:01.892021
...
def upgrade() -> None:
    ...
    sa.Column('found_at', sa.String(length=200), nullable=True),
